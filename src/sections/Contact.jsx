...
import astronot from "../assets/astronot1.png";
...
export default function Contact() {
  ...
  const validateForm = () => {
    ...
    const newErrors = {};
    required.forEach((f) => !formData[f].trim() && (newErrors[f] = "Fill the details in this field"));
    ...
    >
      ...
      <div className="relative z-10 w-full flex flex-col md:flex-row items-center gap-10">
        ...
        >
          ...
          <motion.img src={astronot} alt="contact" 
