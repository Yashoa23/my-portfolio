    ...
    () => [
      {
        ...
        link: "",
        bgColor: "#0d4d3d",
        image: isMobile ? photo1 : img1, //use mobile aur desktop image
      },
      {
        title: "ChatGpt",
        link: "",
        bgColor: "#3884d3",
        image: isMobile ? photo2 : img2, //use mobile aur desktop image
      },
      {
        title: "AI Project",
        link: "",
        bgColor: "#dc9317",
        image: isMobile ? photo3 : img3, //use mobile aur desktop image
      }
    ],
    [isMobile]
  );
    ...
    >
      ...
      <div className="sticky top-0 h-screen flex flex-col items-center justify-center">
              ...
              <AnimatePresence mode="wait">
                {activeIndex === idx && (
                  <motion.h3 key={project.title}
                    ...
                    className={`sm:mt-10 md:mt-8 lg:mt-0 block text-center text-[clamp(2rem,6vw,5rem)] text-white/95 sm:absolute sm:-top-20 sm:left-[35%] lg:left-[-5%] sm:mb-0
        ...
        <div className={`absolute ${isMobile ? "bottom-20" : "bottom-10"}`}>
          <a href={activeProjects?.link}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block px-6 py-3 font-semibold rounded-lg bg-white text-black hover:bg-gray-200 transition-all "
            aria-label={`View ${activeProjects?.title}`}
          >View Project</a>
        </div>
      </div>
    </section>
