...
const glowVariants = {
  ...
  hover: {
    ...
    transition: {type: 'spring', stiffness: 308, damping: 15}
  },
...
export default function home() {
  ...
  const roles = useMemo(() => ['Web Developer', 'Frontend Developer', 'Software Developer'], []);
  ...
  return(
    <section
    id="home" className="relative w-full h-screen bg-black overflow-hidden">
    <ParticalsBackground/>
    <div className='absolute inset-0'>
      ...
      rounded-full
      bg-linear-to-r from-[#382b63] via-[#80bf8f] to-[#1cd8d2]
    ...
    <div className='relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2'>
      <div className='flex flex-col relative justify-center h-full text-center lg:text-left'>
        <div className='w-full mx-auto lg:pr-20 max-w-3xl'>
          ...
          <motion.h1 className='text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-transparent bg-clip-text
           bg-linear-to-r from-[#1cd8d2] via-[#08bf8f] to-[#302b63] drop-shadow-lg'
          ...
          >
            ...
            bg-linear-to-r from-[#1cd8d2] via-[#08bf8f] to-[#302b63]
      ...
      <div className='relative hidden lg:block'>
        ...
        style={{
          ...
          filter: "blur(38px)", opacity: 0.20,
          background: "conic-gradient(from 0deg, #1cd8d2 , #00bf8f, #302b63, #1cd8d2)"
        }} 
        />

        <motion.img src={avator} alt="Yashoda" 
